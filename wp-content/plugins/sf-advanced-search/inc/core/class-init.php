...
use SF_Advanced_Search\Inc\Admin as Admin;
use SF_Advanced_Search\Inc\Common as Common;
use SF_Advanced_Search\Inc\Frontend as Frontend;
...
class Init {
	...
	private function define_common_hooks() {
		...
		$this->loader->add_action( 'wp_ajax_sf_advanced_search_autosuggest', $plugin_common, 'advanced_search_autosuggest_handler' );
		$this->loader->add_action( 'wp_ajax_nopriv_sf_advanced_search_autosuggest', $plugin_common, 'advanced_search_autosuggest_handler' );
		...
		// search form submission handler when a form is submitted to admin-post.php
		$this->loader->add_action( 'admin_post_sf_advanced_search_form_response', $plugin_common, 'advanced_search_form_response_handler');
		$this->loader->add_action( 'admin_post_nopriv_sf_advanced_search_form_response', $plugin_common, 'advanced_search_form_response_handler');
		// search form submission handler when a form is submitted to admin-ajax.php
		$this->loader->add_action( 'wp_ajax_sf_advanced_search_form_response', $plugin_common, 'advanced_search_form_response_handler' );
		$this->loader->add_action( 'wp_ajax_nopriv_sf_advanced_search_form_response', $plugin_common, 'advanced_search_form_response_handler' );
